module decoder_riscv (
  ...
  case(fetched_instr_i[6:2])
    ...
    OP_OPCODE: begin
        ...
        default : begin illegal_instr_o <= 1; gpr_we_a_o <= 0; end
    ...
    b_sel_o <= OP_B_IMM_I;
        ...
        10'h0 : alu_op_o <= ALU_ADD; 
        10'h2 : alu_op_o <= ALU_LTS; 
        10'h3 : alu_op_o <= ALU_LTU;
        10'h4 : alu_op_o <= ALU_XOR;
        10'h6 : alu_op_o <= ALU_OR;
        10'h7 : alu_op_o <= ALU_AND;
    ...
    b_sel_o <= OP_B_IMM_S; gpr_we_a_o <= 0;
    ...
    10'h00_0 : begin alu_op_o <= ALU_AND; b_sel_o <= OP_B_IMM_I; end
    
    10'h01_0 : begin alu_op_o <= ALU_AND; b_sel_o <= OP_B_IMM_I; end
